...
<body>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/cart_page"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a></li>
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img style="width: 15%" src="images/shop/model1.jpg" alt=""></a>
							</td>
							<td class="cart_description">
								<h5><a href="">Bitis Hunter X</a></h5>
								<h6>Mã sản phẩm</h6>
							</td>
							<td class="cart_price">
								<h5>$59</h5>
							...
							<td class="cart_quantity">
								<form action="">
									<input style="width: 60px" name="quantity" min="1" type="number" value="1" title="Qty">
	...
	<section id="do_action">
		<div class="container">
			<div class="heading">
				<p><strong style="color: red">Vui lòng kiểm tra kĩ các sản phẩm trong giỏ hàng của bạn và số lượng của chúng trước
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Chiết khấu <span>$2</span></li>
							<li>Phí ship <span>Free</span></li>
							<li>Phải thanh toán <span>$61</span></li>
						</ul>
						<div style="text-align: center">
							<a class="btn btn-default check_out" href="">Đặt hàng ngay</a>
						</div>
					</div>
				</div>
			</div>
