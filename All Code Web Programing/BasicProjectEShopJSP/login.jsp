				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form">
						...
						<form id="log_form" method="post" action="#">
							...
							<button style="margin-left:80px" type="submit" class="btn btn-default">Đăng nhập ngay</button>
						</form>
					</div>
					<!--/login form-->
				</div>
				...
				<div class="col-sm-4">
					<div class="signup-form">
						...
						<form id="reg_form" method="post" action="#">
							...
							<button style="margin-left:120px" type="submit" class="btn btn-default">Đăng kí ngay</button>
						</form>
					</div>
					<!--/sign up form-->
				</div>
