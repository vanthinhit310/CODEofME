    ...
    <script>
        $(document).ready(function () {
            $('#forgotpassword_form').on('submit', function () {
                if ($('#forgotpass_username').val() == '' || $('#forgotpass_username').val() == undefined) {
                    $('#err_forgotpass_username').html('Vui lòng nhập tên tài khoản');
                    $('#forgotpass_username').css('border', 'solid 1px red');
                    return false;
                }
                if ($('#forgotpassword_email').val() == '' || $('#forgotpassword_email').val() == undefined) {
                    ...
                    $('#forgotpassword_email').css('border', 'solid 1px red');
                    return false;
                }
                return true;
            });
            $('#forgotpassword_form').on('keyup', function () {
                if ($('#forgotpass_username').val() != '') {
                    $('#err_forgotpass_username').html('');
                    $('#forgotpass_username').css('border', 'solid 2px green');
                }
        ...
        <div class="col-sm-4 col-sm-offset-4">
            <div class="login-form">
                ...
                <form id="forgotpassword_form" method="post">
                    <input id="forgotpass_username" name="forgotpass_username" type="text" placeholder="Tên tài khoản" />
                    <p style="color:red" id="err_forgotpass_username"></p>

                    <input id="forgotpassword_email" name="forgotpassword_email" type="text" placeholder="Email đăng kí tài khoản" />
                    <p style="color:red" id="err_forgotpassword_email"></p>
