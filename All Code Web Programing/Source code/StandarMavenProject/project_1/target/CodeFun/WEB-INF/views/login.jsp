...
<script>
    $(document).ready(function(){
        ...
        $('#reg_form').on('submit', function(){
            ...
            if($('#reg_username').val() == '' || $('#reg_username').val() == undefined){
                $('#err_username_reg').html('Vui lòng nhập tên tài khoản');
                $('#reg_username').css('border','solid 1px red');
                return false;
            }
            ...
            if($('#reg_phonenumber').val() == '' || $('#reg_phonenumber').val() == undefined){
                $('#err_phonenumber_reg').html('Vui lòng xác nhận mật khẩu');
                $('#reg_phonenumber').css('border','solid 1px red');
                return false;
            }
            return true;
        });
        $('#reg_form').on('keyup', function(){
            ...
            if($('#reg_phonenumber').val() != ''){
                $('#err_phonenumber_reg').html('');
                $('#reg_phonenumber').css('border','solid 2px green');
            }
            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <form id="log_form" method="post" action="#">
                        ...
                        <button style="margin-left:80px" type="submit" class="btn btn-default"><i class="fa fa-sign-in"> Login</i></button>
                    </form>
                </div><!--/login form-->
            </div>
            <div class="col-sm-1">
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form id="reg_form" method="post" action="#">
                        ...
                        <input id="reg_username" name="reg_username" type="text" placeholder="Tên tài khoản"/>
                        <p style="color:red" id="err_username_reg"></p>
                        ...
                        <input id="reg_confirmpassword" name="reg_confirmpassword" type="password" placeholder="Xác nhận mật khẩu"/>
                        <p style="color:red" id="err_confirmpassword_reg"></p>

                        <input id="reg_phonenumber" name="reg_phonenumber" type="text" placeholder="Số điện thoại"/>
                        <p style="color:red" id="err_phonenumber_reg"></p>
                        <button style="margin-left:120px" type="submit" class="btn btn-default"><i class="fa fa-user">Register</i></button>
                    </form>
                </div><!--/sign up form-->
            </div>
        </div>
