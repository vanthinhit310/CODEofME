        ...
        <div class="col-sm-4 col-sm-offset-4">
            <div class="login-form"><!--login form-->
                ...
                <form id="changepassword_form" method="post">
                    <input id="changepassword_oldpassword" name="changepassword_oldpassword" type="password" placeholder="Old password" />
                    <p style="color:red" id="err_changepassword_oldpassword"></p>

                    <input id="changepassword_newpassword" name="changepassword_newpassword" type="password" placeholder="New password" />
                    <p style="color:red" id="err_changepassword_newpassword"></p>

                    <input id="changepassword_confirmpassword" name="changepassword_confirmpassword" type="password" placeholder="Confirm password" />
