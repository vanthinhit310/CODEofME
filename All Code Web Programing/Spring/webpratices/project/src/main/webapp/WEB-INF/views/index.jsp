...
<!--/head-->
<%List<Product> products = (List<Product>) request.getAttribute("dsAllProduct");
...
<section>
    <div class="container">
        <div class="row">
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="width: 300px; height: 400px" src="${dsPagination.get(i).productimage}" alt="" />
                                    <h4>${dsPagination.get(i).productname}</h4>
                                    <p>${dsPagination.get(i).productprice}</p>
                                </div>
                            </div>
                            <div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a href="#"><i class="fa fa-plus-square"></i>Thêm vào giỏ hàng</a></li>
                                    <li><a href="/product_details?productid=${dsPagination.get(i).productid}"><i class="fa fa-info"></i>Thông tin</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <!--Phân trang sản phẩm-->
            <ul class="pagination">
                <%int pageNumber = products.size()/6;
