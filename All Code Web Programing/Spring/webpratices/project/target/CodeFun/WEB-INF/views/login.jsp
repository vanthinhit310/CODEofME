        ...
        $('#btnRegister').on('click', function(){
            $.ajax({
                ...
                success : function (data) {
                    var _check= true;
                    var listEmail = data.split('-');
                    if (listEmail.indexOf($('#reg_email').val()) > -1){
                    ...
                    if($('#reg_add').val() == '' || $('#reg_add').val() == undefined){
                        $('#err_email_add').html('Vui lòng nhập email');
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form id="reg_form" method="post" action="Account/register">
                        ...
                        <p style="color:red" id="err_email_add"></p>
                    ...
                    <button id="btnRegister" style="margin-left:120px" type="submit" class="btn btn-default"><i class="fa fa-user">Register</i></button>
                </div><!--/sign up form-->
            </div>
        </div>
    </div>
