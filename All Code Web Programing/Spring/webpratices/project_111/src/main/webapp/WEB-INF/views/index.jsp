...
<!--/head-->
<% List<Sanpham> sanphamList = (List<Sanpham>) request.getAttribute("dsSanpham");
    ...
    <div class="header-bottom">
        ...
        <div class="container">
            <div class="row">
                ...
                <!--/Tìm kiếm sản phẩm-->
                <div class="col-sm-3">
                    <form id="search_box_form" method="post" action="Thanhvien/timkiemsanpham">
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                <h1><span>Wedding</span>-FLOWER</h1>
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="width: 300px; height: 400px" src="${dsPagination.get(i).hinhanhsp}" alt="" />
                                    <h2>${dsPagination.get(i).tensp}</h2>
                                    <p>${dsPagination.get(i).gia}</p>
                                </div>
                            </div>
                            <div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a href="#"><i class="fa fa-plus-square"></i>Thêm vào giỏ hàng</a></li>
                                    <li><a href="/product_details?masp=${dsPagination.get(i).masp}"><i class="fa fa-info"></i>Thông tin</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div style="text-align: center; padding-left: 100px">
                <ul class="pagination">
                    <% int pagenum = sanphamList.size()/6;
                        if(sanphamList.size()%6 !=0){
                            pagenum+=1;
                        }
                        for (int i=1; i<=pagenum; i++){
                    %>
                    <li <%if (pages == i){%> class="active"<%}%> ><a href="/?page=<%=i%>"><%=i%></a></li>
                    <%}%>
                </ul>
