    ...
    <div class="container">
        <div class="col-sm-4 col-sm-offset-4">
            <div class="login-form"><!--login form-->
                ...
                <form id="updatepassword_form" method="post" action="Thanhvien/laylaimatkhau">
                    <input id="updatepassword_newpassword" name="updatepassword_newpassword" type="password" placeholder="Mật khẩu mới" />
                    <p style="color:red" id="err_updatepassword_newpassword"></p>
                    <input style="display: none" name="email" value="<%=request.getParameter("email")%>">
                    <input id="updatepassword_confirmpassword" name="updatepassword_confirmpassword" type="password" placeholder="Nhập lại mật khẩu mới" />
