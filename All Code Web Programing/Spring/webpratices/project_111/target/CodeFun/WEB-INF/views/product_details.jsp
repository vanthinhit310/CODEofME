                ...
                <div class="product-details">
                    ...
                    <div class="col-sm-5">
                        <div class="view-product">
                            <img src="${motSanpham.hinhanhsp}" alt="" />
                        </div>
                    ...
                    <div class="col-sm-7">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <tr>
                                <td><b style="color: blue">Mã sản phẩm</b></td>
                                <td>${motSanpham.masp}</td>
                            </tr>

                            <tr>
                                <td><b style="color: blue">Tên sản phẩm</b></td>
                                <td>${motSanpham.tensp}</td>
                            </tr>

                            <tr>
                                <td><b style="color: blue">Hình ảnh sản phẩm</b></td>
                                <td><img style="width: 90px; height: 90px" src="${motSanpham.hinhanhsp}" alt=""></td>
                            </tr>

                            <tr>
                                <td><b style="color: blue">Mô tả</b></td>
                                <td>${motSanpham.motasp}</td>
                            </tr>

                                <td><b style="color: blue">Giá</b></td>
                                <td style="color: red"><b>${motSanpham.gia}</b></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
