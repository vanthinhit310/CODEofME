				...
				<div style="font-family: serif" class="col-md-12">
					<div class="product-content-right">
						<div class="woocommerce">
							<form id="formtt" action="/payment/themdonhang" class="checkout">
										...
										<table class="shop_table">
											...
											<tbody>
												<tr class="cart_item">
													...
													<td>${tongSL} sản phẩm</td>
												</tr>

												<tr class="cart_item">
													<td style="color: blue"><b>Tổng số tiền phải thanh toán</b> <strong class="product-quantity"></strong>
													</td>
													<td style="color: red"><strong><fmt:formatNumber type="number" pattern="###,###" value="${tonggia}" /> đ</strong></td>
												</tr>
											</tbody>
