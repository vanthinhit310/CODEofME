            ...
            <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                            <div class="related-post-content">
                                                ...
                                                <div class="related-img">
                                                    <a href="#" class="imghover"><img src="images/related_post_1.jpg"
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                            <div class="related-post-content">
                                                <!-- related post -->
                                                <div class="related-img">
                                                    <a href="#" class="imghover"><img src="images/related_post_2.jpg"
                                                                                      alt="" class="img-responsive"></a>
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                            <div class="related-post-content">
                                                <!-- related post -->
                                                <div class="related-img">
                                                    <a href="#" class="imghover"><img src="images/related_post_3.jpg"
                                                                                      alt="" class="img-responsive"></a>
                                                </div>
                                                <h4 class="related-title"><a href="#" class="title">E-Commerce Free
                                                        Template</a></h4>
                                    ...
                                    <div class="nav-links">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopr">
                                            <div class="nav-previous">
                                                ...
                                                <h3 class="previous-next-title"><a href="#" class="title">E-Commerce
                                                        Free Template</a></h3>
                                            </div>
                                            <!-- /. nav previous -->
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12 nopl">
                                            <div class="nav-next text-right">
                                                ...
                                                <h3 class="previous-next-title"><a href="#" class="title">Online Mobile
                                                        Store</a></h3></div>
                                            <!-- /.nav previous -->
                                        </div>
                                    </div>
                            ...
                            <div class="author-block">
                                ...
                                <div class="author-content">
                                    ...
                                    <p>Vestibulum pellentesque sitamet arcuporttitor maxi hasellus pellentesques
                                        turpisat auctor volutporbi nuncaugue suscipit nonest sed ullamcorper porta
                                        duaecenas elementum egestas suscipitn elementum.</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <ul class="comment-list">
                                            <li>
                                                <div class="comment-author"><img src="images/user_img_1.jpg" alt=""
                                        ...
                                        <ul class="comment-list">
                                            <li>
                                                <div class="comment-author"><img src="images/user_img_2.jpg" alt=""
                                                                                 class="img-circle"></div>
                                                <div class="comment-info">
                                                    <div class="comment-header">
                                                ...
                                                <ul class="childern">
                                                    <li>
                                                        <div class="comment-author"><img src="images/user_img_3.jpg"
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <ul>
                                <li>
                                    <div class="recent-post">
                                        <h5 class="recent-title "><a href="#" class="title">Online Mobile Store
                                                E-Commerce Free Template</a></h5>
                                        <div class="meta">
                                ...
                                <li>
                                    <div class="recent-post">
                                        <h5 class="recent-title"><a href="#" class="title">Planning for Online Mobile
                                                Shopping? Visit us</a></h5>
                                        <div class="meta">
                                ...
                                <li>
                                    <div class="recent-post">
                                        <h5 class="recent-title"><a href="#" class="title">Mobile Phones Online
                                                Shopping </a></h5>
                                        <div class="meta">
                                            <span class="meta-date">20 December, 2020</span></div>
                                    </div>
                    ...
                    <div class=" widget widget-tags ">
                        ...
                        <div class="widget-body">
                            <a href="#">free template</a><a href="#">template</a><a href="#">responsive Template</a><a
                                href="#">Mobile</a><a href="#">free website template </a><a href="#">E-Commerce</a>
                        </div>
                    </div>
                    <!-- widget-Tag close -->
                </div>
