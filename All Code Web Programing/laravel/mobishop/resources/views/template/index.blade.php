                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                            <div class="slider-captions">
                                <div class="brand-img">
                                    <img src="http://pngimg.com/uploads/apple_logo/apple_logo_PNG19670.png" alt="">
                                </div>
                                <h1 style="color: white" class="slider-title">Iphone <span>XS-Max</span></h1>
                                <a href="#" class="btn btn-primary btn-lg hidden-xs">Add to cart</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                            <div class="slider-captions">
                                <div class="brand-img">
                                    <img
                                        src="https://www.rogers.com/cms/rogers/page-specific/wireless/google-pixel2/images/hero-logo-D.png"
                                        alt="">
                                </div>
                                <a href="#" class="btn btn-primary btn-lg hidden-xs">Add to cart</a>
                            </div>
