    ...
    <div class="container">
        <div class="row">
            ...
            <main class="posts-listing col-lg-8">
                <div class="container">
                    <?php $__currentLoopData = $dsbvtheocm->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dsBaiViet1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row">
                            <!-- post -->
                                ...
                                <article class="post col-xl-6">
                                    ...
                                    <div class="post-details">
                                        ...
                                        <a href="/<?php echo e($dsbv->maloaibv); ?>/<?php echo e($dsbv->url); ?>">
                                            <h3 class="h4"><?php echo e($dsbv->tieudebv); ?></h3></a>
                                        <p class="text-muted"><?php echo e($dsbv->tacgiabv); ?></p>
