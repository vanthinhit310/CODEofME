...
<!-- Bootstrap -->
    ...
    <script>
        function signOut() {
                {{--var pass = '{{Session::get("member")->password}}';--}}
                {{--if (pass === '') {--}}
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="account-section">
                    <ul>
                        @if(Session::get('member')!= null)
                            <li><a href="#" class="title hidden-xs">Hi {{Session::get('member')->name}}</a></li>
                        ...
                        <li><a href="/cart-page" class="title"><i class="fa fa-shopping-cart"></i> <sup id="totalCount"
                                                                                                        class="cart-quantity">{{getCount(Session::get('cart'))}}</sup></a>
                        </li>
                    </ul>
                </div>
                <!-- /.account -->
