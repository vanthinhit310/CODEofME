...
<head>
    ...
    <meta name="google-signin-client_id"
          content="59269859693-7ap3kvjg16jbpmth9g4qjhu0fru0jo8a.apps.googleusercontent.com">
...
<!-- Bootstrap -->
    ...
    <script>
        function signOut() {
            ...
            // setTimeout(function () {
            //     $.ajax({
            //         url: '/controller/template/action/logout',
            //         data: {},
            //         method: 'GET',
...
<div class="top-header">
    <div class="container">
        <div class="row">
            ...
            <?php if(Session::get('member')!= null): ?>
                <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 btn-group">
                    <button class="btn btn-link btn-xs dropdown-toggle top-text"
                            type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-cogs"></i>
                    </button>
                    <div class="dropdown-menu">
                        <li><a href="#">My account</a></li>
                        <li><a href="/changepassword-page">Đổi mật khẩu</a></li>
                    </div>
                </div>
            <?php endif; ?>
            <?php if(Session::get('member')== null): ?>
                <div class="btn-group col-lg-4 col-md-5 col-sm-6 col-xs-12">
                    <button class="btn btn-link btn-xs dropdown-toggle top-text"
                            type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-cogs"></i>
                    </button>
                    <div class="dropdown-menu">
                        <li><a href="/resetyourpassword-page">Quên mật khẩu</a></li>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="account-section">
                    <ul>
                        <?php if(Session::get('member')!= null): ?>
                            <li><a href="#" class="title hidden-xs">Hi <?php echo e(Session::get('member')->name); ?></a></li>
                            <li class="hidden-xs">|</li>
                            <li><a href="/controller/template/action/logout" onclick="signOut()"
                        ...
                        <?php if(Session::get('member')== null): ?>
                            ...
                            <li class="hidden-xs">|</li>
                            <li><a href="/register-page" class="title hidden-xs">Register</a></li>
                        <?php endif; ?>
                        <li><a href="/cart-page" class="title"><i class="fa fa-shopping-cart"></i> <sup id="totalCount"
                                                                                                        class="cart-quantity"><?php echo e(getCount(Session::get('cart'))); ?></sup></a>
                        </li>
                    </ul>
                </div>
                <!-- /.account -->
