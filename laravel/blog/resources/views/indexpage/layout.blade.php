...
@yield('title')
<!-- Bootstrap core CSS -->
    <link href="/indexpage/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="/indexpage/css/clean-blog.min.css" rel="stylesheet">
</head>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="/"><img src="indexpage/img/logo.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/login_page">Login/Register</a>
                </li>
            </ul>
        </div>
    </div>
